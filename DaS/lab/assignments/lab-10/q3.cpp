...
// Helper to swap two elements. Used by both MinMaxHeap and HeapSort/Kth Largest.
...
// --- Utility for Task 2/3: Heap Sort (Max Heapify) ---
...
int findKthLargest(int arr[], int size, int k) {
    ...
    // In a real application, dynamic allocation or STL would be used.
